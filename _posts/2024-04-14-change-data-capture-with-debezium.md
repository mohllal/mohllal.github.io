---
layout: post
title: "Real-Time Change Data Capture (CDC) using PostgreSQL, Debezium, Kinesis, and EventBridge"
date: 2024-04-14
description: 'Capture data changes and deliver events to downstream systems with an event-driven CDC architecture.'
image: '/assets/images/posts/change-data-capture-with-debezium/preview.png'
tags:
- change data capture
- debezium
- aws
excerpt: 'Capture data changes and deliver events to downstream systems with an event-driven CDC architecture.'
---

In this article, we will explore how to build a **Change Data Capture (CDC)** pipeline to capture data changes in a PostgreSQL database and propagate those changes in real-time using Debezium, AWS Kinesis, and EventBridge. We will cover the fundamental concepts of CDC, describe its use cases, and walk through a complete implementation with code examples.

The code snippets provided here are snipped for demonstration purposes. You can find the complete implementation in this [repository](https://github.com/mohllal/postgresql-debezium-kinesis-cdc).
...
<figure class="image-figure">
  <img src="/assets/images/posts/change-data-capture-with-debezium/change-data-capture-architecture.png" alt="Change Data Capture (CDC) Architecture">
  <figcaption>Change Data Capture (CDC) Architecture</figcaption>
</figure>
...
<figure class="image-figure">
  <img src="/assets/images/posts/change-data-capture-with-debezium/change-data-capture-pipeline.png" alt="Change Data Capture (CDC) Pipeline">
