...
<i title="Express.js" class="devicon-express-original colored tech-icon"></i>
<img title="Mocha" src="../images/mocha.png" class="tech-img">
<img title="Flask" src="../images/flask.png" class="tech-img">
<img title="JWT" src="../images/jwt.png" class="tech-img">
<i title="Docker" class="devicon-docker-plain colored tech-icon"></i>
<img title="Jenkins" src="../images/jenkins.png" class="tech-img">
<img title="GitLab CI" src="../images/gitlab-ci.png" class="tech-img">
<i title="Nginx" class="devicon-nginx-original colored tech-icon"></i>
<i title="AWS" class="devicon-amazonwebservices-original colored tech-icon"></i>
<img title="GCP" src="../images/gcp.png" class="tech-img">
<img title="K8S" src="../images/k8s.png" class="tech-img">
